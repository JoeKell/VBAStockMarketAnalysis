...
'This section cleans the data so we don't have the PLNT issue
'Slows the process considerably
    Range("A2").Activate
    Do While ActiveCell.Value <> ""
        If Cells(Selection.Row, 3) = 0 And Cells(Selection.Row, 4) = 0 And Cells(Selection.Row, 5) = 0 And Cells(Selection.Row, 6) = 0 Then
            Rows(Selection.Row & ":" & Selection.Row).Delete
        Else
...
'This helps considerably to give peace of mind
